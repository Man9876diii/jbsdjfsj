...
class uploadVC: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        self.titleTxt.layer.cornerRadius = 5
        self.titleTxt.layer.borderWidth = 2
        self.titleTxt.layer.borderColor = UIColor(red: 255/255.0, green: 89/255.0, blue: 84/255.0, alpha: 1.0).CGColor
    ...
    func imagePickerController(picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [String : AnyObject]) {
        ...
        publishBtn.backgroundColor = UIColor(red: 255.0/255.0, green: 89.0/255.0, blue: 84.0/255.0, alpha: 1)
    ...
    func alignment() {
        ...
        publishBtn.frame = CGRectMake(0, height / 1000, width, width / 8)
        picImg.frame = CGRectMake(140, publishBtn.frame.origin.y + 60, 100, 100)
        removeBtn.frame = CGRectMake(picImg.frame.origin.x, picImg.frame.origin.y + picImg.frame.size.height, picImg.frame.size.width, 20)
        titleTxt.frame = CGRectMake(85, removeBtn.frame.origin.y + 23, 215, 70 )
