...
class feedVC: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        if tableView(tableView, numberOfRowsInSection: 1) == 0 {
            ...
            emptyStateLabel.text = "Welcome to The Meme App follow people in the explore section and there content will show here when you scoll down."
            
            emptyStateLabel.lineBreakMode = .ByWordWrapping // or NSLineBreakMode.ByWordWrapping
